...
export default function SearchableTransferList({leftTitle, leftData, rightTitle, rightData, getId, getValue}) {
  ...
  const leftFiltered = filter(left, leftFilter);
  const rightFiltered = filter(right, rightFilter);
